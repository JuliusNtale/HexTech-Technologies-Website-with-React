      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Browse our complete catalog of technology equipment, place orders online, and get it delivered to your doorstep anywhere in Tanzania.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="text-center mt-12">
            <p className="text-gray-600 mb-6">
              Available online at <strong>eshop.neuraltale.com</strong>
            </p>
