    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <div className="relative h-full overflow-hidden bg-white dark:bg-zinc-900">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-5">
                        <div className="flex items-center justify-between gap-3">
                            ...
                            <div className="relative group/icon">
                                ...
                                />
                                <Repeat2 className="relative z-10 w-4 h-4 text-amber-500 transition-transform duration-300 group-hover/icon:scale-110 group-hover/icon:-rotate-12" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="pt-6 mt-6 border-t border-zinc-200 dark:border-zinc-800">
                        ...
                        >
                            <span className="text-sm font-medium text-zinc-900 dark:text-white transition-colors duration-300 group-hover/start:text-amber-600 dark:group-hover/start:text-amber-400">
                                Start today
                            </span>
                            <div className="relative group/icon">
                                <div
                                ...
                                />
                                <ArrowRight className="relative z-10 w-4 h-4 text-amber-500 transition-all duration-300 group-hover/start:translate-x-0.5 group-hover/start:scale-110" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <style jsx>{`
                @keyframes scale {
                    0% {
                        transform: scale(2);
                        opacity: 0;
                        box-shadow: 0px 0px 50px rgba(245, 158, 11, 0.5);
                    }
                    50% {
                        transform: translate(0px, -5px) scale(1);
                        opacity: 1;
                        box-shadow: 0px 8px 20px rgba(245, 158, 11, 0.5);
                    }
                    100% {
                        transform: translate(0px, 5px) scale(0.1);
                        opacity: 0;
                        box-shadow: 0px 10px 20px rgba(245, 158, 11, 0);
                    }
                }
            `}</style>
        </div>
